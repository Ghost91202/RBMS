...
export default function section2( { } ) {
    ...
    return (
        <div className="flex flex-col  w-screen overflow-hidden bg-slate-50  gap-10  justify-center p-10 h-auto">
            <h1 className="lg:text-5xl text-3xl font-bold  flex items-start justify-center">Who we’re built for</h1>
            <div className=" flex justify-center items-center">
                ...
                <div className=" flex relative overflow-hidden flex-col  rounded-2xl h-auto  bg-white p-10">
                    <h1 className="lg:text-3xl font-bold">B2Bs</h1>
                    ...
                    <div className="border-l-2 relative flex flex-col gap-5 pl-5 border-slate-800">
                ...
                <div className=" flex flex-col relative overflow-hidden rounded-2xl   bg-white p-10">
                    <h1 className="lg:text-3xl font-bold">High-ticket B2Cs</h1>
                    ...
                    <div className="border-l-2 flex flex-col gap-5 pl-5 border-slate-800">
                        <span className="lg:text-4xl ">"</span>
