...
import SEOIMG from "../../assets/seo.avif"
import SEOIMG1 from "../../assets/seo1.avif"
import { FcElectricity } from "react-icons/fc";

export default function section1() {
    return (
        <div className="flex relative  flex-col gap-10 justify-center w-screen overflow-hidden h-auto lg:pb-2 lg:p-20">
           <div> <h1 className="lg:text-5xl text-xl font-bold flex justify-center">We&apos;re not your typical “Digital Marketing agency”</h1>
            ...
            <div className="p-10">
                ...
                <div className="flex flex-col gap-5">
                    <h1 className="lg:text-4xl text-xl font-semibold">360° Digital Marketing Services</h1>
